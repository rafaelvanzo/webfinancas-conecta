...
if( !isset($_SESSION['permissao_contador']) || $_SESSION['permissao_contador']!= 1 ){
	...
	header('location:'.$httpProtocol.$baseUrl.'/#login');
    break;
    ...
    $raiz = $httpProtocol.$baseUrl."/sistema/";
...
<script type="text/javascript" src="'.$raiz.'js/plugins/tables/fnSetFilteringDelay.js"></script>
