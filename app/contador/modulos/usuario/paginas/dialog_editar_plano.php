    ...
    <!-- TODOS OS VALOR DOS MÓDILOS MARCADOS -->   
                        ...
                        <tbody>
                            ...
                            <input type="hidden" id="tp_plano_atual" name="tp_plano_atual" value="<?php echo $dados_plano['periodo']; ?>" />
                                ...
                                <td>
                            <select class="select_ano" name="vencimento"  id="vencimento" style="width: auto;">                       
															<option value="5" <?php if($dados_plano['dia_vencimento'] == '5'){ echo 'selected="selected"'; } ?> >Todo o dia 05</option>													
															<option value="15" <?php if($dados_plano['dia_vencimento'] == '15'){ echo 'selected="selected"'; } ?> >Todo o dia 15</option>
															<option value="25" <?php if($dados_plano['dia_vencimento'] == '25'){ echo 'selected="selected"'; } ?> >Todo o dia 25</option>													
														</select>  
                                </td>
                            </tr>
                        </tbody>
