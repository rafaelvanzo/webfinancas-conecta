...
================================================== */
	...
	*/
	...
	$('.timepicker').timeEntry({
		...
		spinnerImage: '../../sistema/images/forms/spinnerUpDown.png', // Arrows image
...
*/	
	...
	$('<span class="check-autocomplete-container" style="display:none"><img src="../../sistema/images/loaders/loader9.gif" width="14" alt="" class=" tipS" title="Aguarde"/></span>').insertAfter(".input-buscar");
    $('<span class="close-autocomplete-container close-red"><img src="../../sistema/images/icons/color/close_red.png" alt="" class=" tipS" title="Limpar seleção"/></span>').insertAfter(".input-buscar");
	$('<span class="check-autocomplete-container check-green" style="display:none"><img src="../../sistema/images/icons/color/check_green.png" alt="" class=" tipS" title="Opção selecionada"/></span>').insertAfter(".input-buscar");
	$('<span class="check-autocomplete-container check-dark"><img src="../../sistema/images/icons/dark/check.png" alt="" class="tipS check-dark" title="Selecione uma opção"/></span>').insertAfter(".input-buscar");
	...
	var plc_render_item = function (ul, item) {
	    ...
	    if (item.tp_ctr_plc == 1) {
	        ...
	        return $("<li class='ui-state-disabled' style='color:black;'>").append("<span>" + item.label + "</span>").appendTo(ul);
	    }
	}
	...
	*/
	...
	$(".buscar-cliente").autocomplete({
	    source: function (request, response) {
	        ...
	        $.ajax({
	            url: 'php/Route.php?Controller=Arquivo&Action=AutoCompleteCliente',
	            dataType: "json",
	            data: request,
	    ...
	    select: function (event, ui) {
            ...
            //Dispara o evento de alteração do input hidden contendo id do cliente da contabilidade para renderizar o data table
	        $('#cliente_id').trigger('change');

	        //Coloca id do cliente na sessão
	        $.ajax({
	            url: 'php/Route.php?Controller=Util&Action=SetSessionCliente',
	            dataType: "json",
	            data: { cliente_id: ui.item.id, nome: ui.item.label },
	            success: function (data) {
	            }
	        });
	    },
    ...
    /*
	var cache = { term: null, data: null };
	$(".buscar-cliente").autocomplete({
	    minLength: 0,
	    source: function (request, response) {
	        var term = request.term;
	        if ( term == cache.term && cache.data) {
	            response(cache.data);
	            return;
	        }
	        $.getJSON("php/Route.php?Controller=Arquivo&Action=AutoCompleteCliente", request, function (data, status, xhr) {
    ...
    */
    ...
    //Verifica se autocomplete da contabilidade foi preenchido pela sessão e bloqueia o input
	if ($('#input-buscar-cliente').val() != 0) {
	    $('#cliente_id_cg').css('display', 'block');
	    $('#input-buscar-cliente').attr('disabled', 'disabled');
	}
    ...
    if (lancamentos != "") {
        ...
        for (var i = 0; i < qtd_lancamentos; i++) {
            if (lancamentos[i].operacao != 3) {
                ...
                $("#" + form + "_ct_resp_exibir").append('<li class="ct_resp_lancamento" id="ct_resp_lancamento' + i + '"><div class="floatL"><img src="../../sistema/images/icons/updateDone.png" alt="" style="padding-top: 2px; padding-right: -3px;"> <br /><img src="../../sistema/images/icons/updateDone.png" alt="" style="padding-top: 4px; padding-right: -3px;"></div><div class="pInfo" align="left"><strong>CT: </strong>' + conta + '<br /><strong>CC: </strong>' + centro + '</div><div class="floatR"><span style="display: inline-table; vertical-align: top;">R$ ' + valor_novo + ' <br />' + porcentagem + '%</span><span style="display: inline-table;"><a href="javascript://void(0);" title="Excluír" class="smallButton" style="margin-top: 5px; margin-left: 5px; width: 14px;" onClick="centroRespLnctExcluir(\'' + form + '\',\'' + i + '\')"><img src="../../sistema/images/icons/dark/close.png" alt=""></a></span></div></li>');
            }
        }
...
function valorPorcentagem(form) {
    ...
    var total = txtToValor($('#' + form + '_valor').val());
...
function centroRespLnctIncluir(form) {
    ...
    if (validacao) {
        ...
        $("#" + form + "_ct_resp_exibir").append('<li class="ct_resp_lancamento" id="ct_resp_lancamento' + qtd_lancamentos + '"><div class="floatL"><img src="../../sistema/images/icons/updateDone.png" alt="" style="padding-top: 2px; padding-right: -3px;"> <br /><img src="../../sistema/images/icons/updateDone.png" alt="" style="padding-top: 4px; padding-right: -3px;"></div><div class="pInfo" align="left"><strong>CT: </strong>' + conta + '<br /><strong>CC: </strong>' + centro + '</div><div class="floatR"><span style="display: inline-table; vertical-align: top;">R$ ' + valor + ' <br />' + porcentagem + '%</span><span style="display: inline-table;"><a href="javascript://void(0);" title="Excluír" class="smallButton" style="margin-top: 5px; margin-left: 5px; width: 14px;" onClick="centroRespLnctExcluir(\'' + form + '\',\'' + qtd_lancamentos + '\')"><img src="../../sistema/images/icons/dark/close.png" alt=""></a></span></div></li>');
