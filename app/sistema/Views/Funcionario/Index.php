...
<div class="wrapper">  
   <div class="bc" style="margin:2px 0 0 0;">
    ...
    <!-- Botões -->
    <div class="wrapper">        	    
        <a href="#" title="" class="button greenB" style="margin: 5px;" id="open-modal-funcionario"><img src="images/icons/light/add.png" alt="" class="icon"/><span>Novo Funcionário</span></a>
    </div>
...
<div class="wrapper">
    ...
    <div class="widget">
        <div id="funcionarios">
            <table class="display" id="dTableFuncionarios">
                <tbody></tbody>
		    </table>
        </div>
    </div>
