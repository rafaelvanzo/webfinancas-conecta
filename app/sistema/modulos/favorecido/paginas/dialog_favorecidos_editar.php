              ...
              <div id="dialog-message-favorecido-editar" style="height:auto; padding:0;" title="Editar Favorecido">
								
                <form id="form_favorecidos_editar" class="dialog">
                                     ...
                                     <div class="fluid">      
                                              ...
                                              <div class="formRow">
                                                  ...
                                                  <span class="span3">
                                                  		...
                                                  		<input type="text" name="cpf_cnpj" class="cpf_cnpj" id="cpf_cnpj" value="" onkeypress="checkCpfCnpj();" />
                                                  </span>
                                                  <span class="span3">
                                                  		<label>Tipo:</label>
