...
<div class="fluid">
        ...
        <div class="formRow">   
            ...
            <span class="span2">
                ...
                <input type="text" name="dt_inicio" class="dt_inicio datepicker maskDate required" placeholder="__/__/____"/>
             </span>
             <span class="span2">
    ...
    <div class="linha" ></div>
        <div class="formRow">
            <span class="span12">
               ...
               <textarea name="descricao" rows="10" placeholder="Escreva o informativo" class="descricao required"></textarea>
             </span>
        </div>
