              ...
              <div id="dialog-pgto-incluir" style="height:auto; padding:0;" title="Incluír Novo Pagamento">
                                              ...
                                              <div class="formRow">
                                                  ...
                                                  <span class="span6">
                                                      <label>Pagar para:</label>
                                                 		  <input style="margin-left: 0px;" type="text" name="favorecido_pgto_id" value="" class="required favorecido_buscar" placeholder="Preencha para localizar..." />
                                               ...
                                               <div class="formRow">
                                                  <span class="span6">
                                                      <label>Conta:</label>
                                                      <input style="margin-left: 0px;" type="text" name="conta_pgto_id" value="" class="required conta_buscar" placeholder="Preencha para localizar..." />
