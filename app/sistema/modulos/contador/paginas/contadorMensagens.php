<?php
require("modulos/contador/class/ContadorMensagens.class.php");
...
<div class="wrapper">
	...
	<a href="#" title="" class="button blueB" style="margin: 5px;" id="opener-add-mensagem"><img src="images/icons/light/speech.png" alt="" class="icon"><span>Nova solicitação</span></a>
