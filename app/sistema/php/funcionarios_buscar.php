...
if (!$q || $q==""){
	$query = mysql_query("select id, nome from funcionarios order by nome");
}else{
	$query = mysql_query("select id, nome from funcionarios where nome LIKE '%".$q."%' order by nome")or die(mysql_error());
}
