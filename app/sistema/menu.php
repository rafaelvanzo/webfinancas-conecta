...
<div id="leftSide" class="noPrint">
    ...
    <ul id="menu" class="nav">
        ...
        <?php if(($_SESSION['parceiro_id']==342 || $_SESSION['cliente_id'] ==342) && in_array(30,$_SESSION['permissoes'])){ ?>
        <li class="calc" ><a href="custeio" title="" <?php if($page == "custeio"){ echo 'class="active"'; }?> ><span>Custeio</span></a></li>
        <?php } ?>
        ...
        <div class="wrapper">
            ...
            <div class="userNav">
                <ul>
                    ...
                    <?php if(isset($_SESSION['retorno_parceiro_id'])){ ?>  <li ><a href="javascript://" onclick="acessarConador(<?php echo $_SESSION['retorno_parceiro_id'];?>);" title="Retornar para area do contador" ><img src="images/icons/light/refresh2.png" alt=""/><span>Sistema Contador</span><!--<span class="numberTop">1</span>--></a></li> <?php } ?>
                
                    <?php if($_SESSION['parceiro_id']==342){ ?>  <li ><a href="https://agenda.webfinancas.com/Login/LoginExterno/<?php echo $_SESSION['cliente_id'].'_'; echo $_SESSION['email']; ?>" title="Acesse a agenda" target="_blank"><img src="images/icons/light/refresh2.png" alt=""/><span>Agenda</span><!--<span class="numberTop">1</span>--></a></li> <?php } ?>
                

                   <?php if($_SESSION['contador_acesso']==1 && !isset($_SESSION['retorno_parceiro_id'])){ ?>  <li id="li-area-contador" ><a href="<?php echo $protocolo.$baseUrl; ?>/contador/" title=""><img src="images/icons/light/refresh2.png" alt=""/><span>Contabilidade</span><!--<span class="numberTop">1</span>--></a></li> <?php } ?>
    ...
    <div class="resp noPrint">
        ...
        <div class="smalldd">
            ...
            <span class="goTo">
                        ...
                        else if( $page == 'custeio' ){ echo '<img src="images/icons/light/calc.png" alt="" />Custeio'; }
            ...
            <ul class="smallDropdown">
                ...
                <?php if( ($_SESSION['parceiro_id']==342 || $_SESSION['cliente_id'] ==342) &&  in_array(30,$_SESSION['permissoes']) ) echo '<li><a href="custeio" title="" ><img src="images/icons/light/frames.png" alt="" />Custeio</a></li>'; ?>
