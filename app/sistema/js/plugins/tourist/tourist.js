...
/* → */
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.skipButtonTemplate = '<button class="button blueB btn-sm pull-right tour-next">Pular</button>';

    Base.prototype.nextButtonTemplate = '<button class="button blueB btn-sm pull-right tour-next">Próximo</button>';

    Base.prototype.finalButtonTemplate = '<button class="button blueB btn-sm pull-right tour-next">Concluir</button>';

    Base.prototype.closeButtonTemplate = '<a class="button blueB btn-close tour-close" href="#"><i class="ui-icon ui-icon-closethick"></i></a>';

    Base.prototype.okButtonTemplate = '<button class="button blueB btn-sm tour-close btn-primary">OK</button>';
    ...
    */
    ...
    Base.prototype._buildContentElement = function(step) {
      ...
      content = $($.parseHTML(this.template({
        ...
        counter: step.final ? '' : "Passo " + (step.index + 1) + " de " + step.total,
