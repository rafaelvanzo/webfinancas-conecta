						...
						<li>
							<a href="#" class="notification-icon">
								<i class="fa fa-bell"></i> 
									...
									echo $num = $this->dbUsuario->numRows('SELECT id FROM favorecidos WHERE WEEK(dtNascimento) = "'.date('W').'" AND YEAR(dtNascimento) = "'.date('Y').'"'); 
									echo ($num > 0) ? '<span class="badge qtdConvites" > '.$num.'</span>' : '';
