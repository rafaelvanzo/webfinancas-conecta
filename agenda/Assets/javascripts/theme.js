...
(function($) {
	...
	if ($.isFunction($.fn['dataTable'])) {
		...
		$.extend(true, $.fn.dataTable.defaults, {
			sDom: "<'row datatables-header form-inline'<'col-sm-2 col-md-2'l><'col-sm-10 col-md-10'f>r><'table-responsive't><'row datatables-footer'<'col-sm-7 'i><'col-sm-5'p>>",
			oLanguage: {
				sLengthMenu: '_MENU_',
				sProcessing: '<i class="fa fa-spinner fa-spin"></i> Carregando',
			    sLoadingRecords: 'Carregando...',
				showNEntries: 'Display _MENU_ records',
				sInfo: 'Total de <b>_MAX_</b> registro(s).',
				sZeroRecords: 'Nenhum registro encontrado.',
				sInfoEmpty: 'Total de <b>_MAX_</b> registro(s).',
				sInfoFiltered: '<br>Localizar: <b>_TOTAL_</b> registro(s) econtrados.',
			...
			fnInitComplete: function( settings, json ) {
				...
				$search
					.attr({
						placeholder: typeof options.searchPlaceholder !== 'undefined' ? options.searchPlaceholder : 'Localizar'
					})
