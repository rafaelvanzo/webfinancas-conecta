   ...
   */
		...
		value: function options() {
			...
			var defaults = {
				...
				label: '<p>Clique ou arraste a imagem aqui</p>',
				labelLoading: '<p>Carregando imagem...</p>',

				// error messages
				statusFileType: '<p>Tipo de arquivo inválido, arquivos permitidos: $0.</p>',
				statusFileSize: '<p>O arquivo é muito grande, tamanho máximo: $0 MB.</p>',
				statusNoSupport: '<p>O seu navegador não suporta essa funcionalidade.</p>',
				statusImageTooSmall: '<p>A imagem é muito pequena, tamanho mínimo: $0 pixels.</p>',
				statusContentLength: '<span class="slim-upload-status-icon"></span> O arquivo é muito grande',
				statusUnknownResponse: '<span class="slim-upload-status-icon"></span> Ocorreu um rrro inesperado',
