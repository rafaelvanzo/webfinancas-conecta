...
(function (factory) {
  ...
  var ui = {
    ...
    hideDialog: function ($dialog) {
        $dialog.modal('hide'); 
        //$("body").addClass("modal-open"); // add codigo para consertar o dialog quando o summernote for utilizado dentro de um dialog (Solução inserida dentro do bootstrap.js)
    },
